...
class BookRequest(BaseModel):
    ...
    published_date : int = Field(le=2050, ge=1950)
...
books = [
    Book(1, 'Computer Science Pro', 'codingwithroby', 'A very nice book!', 5, 1959),
    Book(2, 'Be Fast with FastAPI', 'codingwithroby', 'A great book!', 5, 1974),
    Book(3, 'Master Endpoints', 'codingwithroby', 'An awesome book!', 5, 2011),
    Book(4, 'HP1', 'Author 1', 'Book Description', 2, 2019),
    Book(5, 'HP2', 'Author 2', 'Book Description', 3, 2026),
...
async def read_books_by_publish_date(published_date : int = Query(le=2050, ge=1950)):
    books_to_return = []
    for book in books:
